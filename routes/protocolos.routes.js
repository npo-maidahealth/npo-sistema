...
router.get('/analistas/disponiveis', isAuthenticated, hasPermission(['admin', 'gestor_ti']), async (req, res) => {
    try {
...
router.put('/:id/assumir', isAuthenticated, hasPermission(['analista', 'gestor_ti', 'admin']), async (req, res) => {
...
router.put('/:id/encaminhar-resolucao', isAuthenticated, hasPermission(['analista', 'gestor_ti', 'admin']), async (req, res) => {
    const protocoloId = parseInt(req.params.id, 10);
...
router.put('/:id/analisar', isAuthenticated, hasPermission(['gestor_ti', 'admin']), async (req, res) => {
    const protocoloId = parseInt(req.params.id, 10);
...
router.put('/:id/encerrar', isAuthenticated, hasPermission(['analista', 'gestor_ti', 'admin']), async (req, res) => {
    const protocoloId = parseInt(req.params.id, 10);
...
router.get('/', isAuthenticated, async (req, res) => {
    ...
    try {
        const temPermissaoAdmin = user.cargos.some(c => ['analista', 'gestor', 'admin', 'gestor_ti'].includes(c));
        ...
        const protocolos = temPermissaoAdmin
...
router.put('/:id/triage', isAuthenticated, hasPermission(['admin']), async (req, res) => {
    const protocoloId = parseInt(req.params.id, 10);
...
router.put('/:id/assign', isAuthenticated, hasPermission(['admin', 'gestor_ti']), async (req, res) => {
    const protocoloId = parseInt(req.params.id, 10);
